...
import { BookOpenTextIcon, ClockIcon, FileTextIcon, SparklesIcon } from "lucide-react";
      ...
      <div className="flex flex-col gap-y-4">
        <Tabs defaultValue="summary">
          <div className="bg-white rounded-lg border p-3">
            <ScrollArea>
              <TabsList className="p-0 bg-background justify-center rounded-2xl h-13">
                <TabsTrigger
                  value="summary"
                  className="text-muted-foreground rounded-b-none bg-background data-[state=active]:shadow-none border-b-2 border-transparent data-[state=active]:text-accent-foreground h-full hover:text-accent-foreground"
                >
                  <BookOpenTextIcon />
                  Summary
                </TabsTrigger>
          ...
          <TabsContent value="summary">
            <div className="bg-white rounded-lg border">
              <div className="px-5 py-5 gap-y-5 flex flex-col">
